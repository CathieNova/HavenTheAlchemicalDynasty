...
import net.cathienova.havenalchemy.screen.chests.NetheriteChestMenu;
...
public class NetheriteChestBlockEntity extends ChestBlockEntity implements MenuProvider
{
    private final ChestTypes type = ChestTypes.NETHERITE;
    ...
    public NetheriteChestBlockEntity(BlockPos pPos, BlockState pBlockState)
    {
        super(ModBlockEntities.netherite_chest.get(), pPos, pBlockState);
    ...
    {
        return new NetheriteChestMenu(pContainerId, pPlayerInventory, this, this.data);
    }
