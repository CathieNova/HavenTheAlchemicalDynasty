...
import net.cathienova.havenalchemy.screen.chests.DiamondChestMenu;
...
public class DiamondChestBlockEntity extends ChestBlockEntity implements MenuProvider
{
    private final ChestTypes type = ChestTypes.DIAMOND;
    ...
    public DiamondChestBlockEntity(BlockPos pPos, BlockState pBlockState)
    {
        super(ModBlockEntities.diamond_chest.get(), pPos, pBlockState);
    ...
    {
        return new DiamondChestMenu(pContainerId, pPlayerInventory, this, this.data);
    }
