...
import net.cathienova.havenalchemy.screen.chests.StoneChestMenu;
...
public class StoneChestBlockEntity extends ChestBlockEntity implements MenuProvider
{
    private final ChestTypes type = ChestTypes.STONE;
    ...
    {
        super(ModBlockEntities.stone_chest.get(), pPos, pBlockState);
    ...
    {
        return new StoneChestMenu(pContainerId, pPlayerInventory, this, this.data);
    }
