...
import net.cathienova.havenalchemy.screen.chests.IronChestMenu;
...
public class IronChestBlockEntity extends ChestBlockEntity implements MenuProvider
{
    private final ChestTypes type = ChestTypes.IRON;
    ...
    {
        return new IronChestMenu(pContainerId, pPlayerInventory, this, this.data);
    }
