...
import net.cathienova.havenalchemy.screen.chests.EmeraldChestMenu;
...
public class EmeraldChestBlockEntity extends ChestBlockEntity implements MenuProvider
{
    private final ChestTypes type = ChestTypes.EMERALD;
    ...
    public EmeraldChestBlockEntity(BlockPos pPos, BlockState pBlockState)
    {
        super(ModBlockEntities.emerald_chest.get(), pPos, pBlockState);
    ...
    {
        return new EmeraldChestMenu(pContainerId, pPlayerInventory, this, this.data);
    }
