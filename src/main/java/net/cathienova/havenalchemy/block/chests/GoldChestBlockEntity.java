...
import net.cathienova.havenalchemy.screen.chests.GoldChestMenu;
...
public class GoldChestBlockEntity extends ChestBlockEntity implements MenuProvider
{
    private final ChestTypes type = ChestTypes.GOLD;
    ...
    public GoldChestBlockEntity(BlockPos pPos, BlockState pBlockState)
    {
        super(ModBlockEntities.gold_chest.get(), pPos, pBlockState);
    ...
    {
        return new GoldChestMenu(pContainerId, pPlayerInventory, this, this.data);
    }
