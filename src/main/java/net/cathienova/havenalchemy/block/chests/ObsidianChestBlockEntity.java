...
import net.cathienova.havenalchemy.screen.chests.ObsidianChestMenu;
...
public class ObsidianChestBlockEntity extends ChestBlockEntity implements MenuProvider
{
    private final ChestTypes type = ChestTypes.OBSIDIAN;
    ...
    public ObsidianChestBlockEntity(BlockPos pPos, BlockState pBlockState)
    {
        super(ModBlockEntities.obsidian_chest.get(), pPos, pBlockState);
    ...
    {
        return new ObsidianChestMenu(pContainerId, pPlayerInventory, this, this.data);
    }
