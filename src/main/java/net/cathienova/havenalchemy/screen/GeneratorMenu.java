...
public class GeneratorMenu extends AbstractContainerMenu {
    ...
    public GeneratorMenu(int windowId, Player player, BlockPos pos) {
        ...
        layoutPlayerInventorySlots(player.getInventory(), 8, 70);
    }
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(player.level(), pos), player, ModBlocks.generator_block.get());
    }
}
