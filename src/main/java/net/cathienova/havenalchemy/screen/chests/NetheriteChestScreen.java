...
public class NetheriteChestScreen extends AbstractContainerScreen<NetheriteChestMenu>
{
    private static final ResourceLocation BACKGROUND = new ResourceLocation(HavenAlchemy.MOD_ID, "textures/gui/emerald_chest.png");

    public NetheriteChestScreen(NetheriteChestMenu pMenu, Inventory pPlayerInventory, Component pTitle)
    {
