...
import net.cathienova.havenalchemy.block.chests.ObsidianChestBlockEntity;
...
public class ObsidianChestMenu extends AbstractContainerMenu
{
    public final ObsidianChestBlockEntity blockEntity;
    ...
    public ObsidianChestMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(SLOTS));
    }

    public ObsidianChestMenu(int pContainerId, Inventory playerInventory, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.OBSIDIAN_CHEST_MENU.get(), pContainerId);
        checkContainerSize(playerInventory, 36);
        blockEntity = ((ObsidianChestBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.obsidian_chest.get());
    }
