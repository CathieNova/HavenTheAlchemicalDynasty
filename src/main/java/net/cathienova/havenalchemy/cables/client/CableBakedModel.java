package net.cathienova.havenalchemy.cables.client;

import net.cathienova.havenalchemy.HavenAlchemy;
import net.cathienova.havenalchemy.cables.ConnectorType;
import net.cathienova.havenalchemy.cables.blocks.CableBlock;
import net.cathienova.havenalchemy.cables.client.CablePatterns.Pattern;
import net.cathienova.havenalchemy.cables.client.CablePatterns.QuadSetting;
...
import static net.cathienova.havenalchemy.cables.ConnectorType.*;
import static net.cathienova.havenalchemy.cables.client.CablePatterns.SpriteIdx.*;
import static net.cathienova.havenalchemy.util.BakedModelHelper.quad;
import static net.cathienova.havenalchemy.util.BakedModelHelper.v;
...
public class CableBakedModel implements IDynamicBakedModel {
    ...
    private TextureAtlasSprite getTexture(String path) {
        return Minecraft.getInstance().getTextureAtlas(InventoryMenu.BLOCK_ATLAS).apply(new ResourceLocation(HavenAlchemy.MOD_ID, path));
    }
