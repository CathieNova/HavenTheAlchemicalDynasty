...
import net.cathienova.havenalchemy.item.sculkerite.WardenEars;
...
public class ModTrinketRenders implements ICurioRenderer
{
    @Override
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack poseStack,
        ...
        if (stack.getItem() instanceof WardenEars) {
            poseStack.pushPose();
            poseStack.popPose();
        }
    }
