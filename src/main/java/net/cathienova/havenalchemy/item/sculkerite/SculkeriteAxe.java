...
public class SculkeriteAxe extends AxeItem {
    public SculkeriteAxe(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
