...
public class NightvisionGoggles extends ArtifactBase
{
    ...
    {
        tooltip.add(Component.translatable("tooltip.havenalchemy.nightvision_goggles").withStyle(ChatFormatting.GOLD));
    }
